...
//==============================================================================
FFTWOLATestAudioProcessor::FFTWOLATestAudioProcessor()
                       ...
                       ),m_algo(this), m_parameterVTS(nullptr)
{
    ...
    m_parameterVTS = std::make_unique<AudioProcessorValueTreeState>(*this, nullptr, Identifier("FFTWOLATestVTS"),
...
//==============================================================================
const juce::String FFTWOLATestAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool FFTWOLATestAudioProcessor::acceptsMidi() const
{
...
bool FFTWOLATestAudioProcessor::producesMidi() const
{
...
bool FFTWOLATestAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double FFTWOLATestAudioProcessor::getTailLengthSeconds() const
{

    return 0.0;
}

int FFTWOLATestAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int FFTWOLATestAudioProcessor::getCurrentProgram()
{
    return 0;
}

void FFTWOLATestAudioProcessor::setCurrentProgram (int index)
{
    juce::ignoreUnused (index);
}

const juce::String FFTWOLATestAudioProcessor::getProgramName (int index)
{
    juce::ignoreUnused (index);
    return {};
}

void FFTWOLATestAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
    juce::ignoreUnused (index, newName);
}

//==============================================================================
void FFTWOLATestAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void FFTWOLATestAudioProcessor::releaseResources()
{
    // When playback stops, you can use this as an opportunity to free up any
    // spare memory, etc.
}

bool FFTWOLATestAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void FFTWOLATestAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer,
...
//==============================================================================
bool FFTWOLATestAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* FFTWOLATestAudioProcessor::createEditor()
{
    return new FFTWOLATestAudioProcessorEditor (*this);
}

//==============================================================================
void FFTWOLATestAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void FFTWOLATestAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new FFTWOLATestAudioProcessor();
}
