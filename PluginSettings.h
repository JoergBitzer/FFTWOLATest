...
// ------------Audio -----------------
const float g_desired_blocksize_ms(25); // its in ms to be independent from the sampling rate
const bool g_forcePowerOf2(true); // should be true for FFT Processing

// -------------- GUI -----------------
// global GUI setting for FFTWOLATest
