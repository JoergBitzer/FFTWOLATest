...
//==============================================================================
class FFTWOLATestAudioProcessor  : public juce::AudioProcessor
{
public:
    friend class FFTWOLATestAudioProcessorEditor;
    //==============================================================================
    FFTWOLATestAudioProcessor();
    ~FFTWOLATestAudioProcessor() override;
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FFTWOLATestAudioProcessor)
};
